...
package com.wenqi.ordermanagement.wxpay.sdk;

import com.wenqi.ordermanagement.wxpay.sdk.WXPayConstants.SignType;
...
//        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getPrivateKey(), this.signType));
        return reqData;
    }
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getPrivateKey(), this.signType);
    }
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getPrivateKey(), signType);
    }
